...
**Backend is a domain. Frameworks are different ways of building one.** This folder is organised that way: sections `01`–`07` are the course — true regardless of language — and [[backend/frameworks/index|frameworks/]] holds the implementations.
...
### [[backend/01-foundations/index|01 — Foundations]]
...
### [[backend/02-api-design/index|02 — API Design]]
...
### [[backend/06-cross-cutting/index|06 — Cross-Cutting Concerns]]
...
## [[backend/frameworks/index|frameworks/]] — the implementations

Not numbered; there's no reading order. Pick yours.

- **[[backend/frameworks/javascript/index|JavaScript/TypeScript]]** — [[backend/frameworks/javascript/01-node-runtime/index|Node runtime]], [[backend/frameworks/javascript/02-express/index|Express]], [[backend/frameworks/javascript/03-nest/index|Nest]] — event loop
- **[[backend/frameworks/java/index|Java]]** — [[backend/frameworks/java/01-spring-boot|Spring Boot]] — thread-per-request, virtual threads from 21. Moved here from `languages/01-java/`
- **[[backend/frameworks/python/index|Python]]** — FastAPI, Django, Flask — mixed WSGI/ASGI
- **[[backend/frameworks/csharp/index|C#]]** — ASP.NET Core — async, thread pool
- **[[backend/frameworks/go/index|Go]]** — net/http, Chi, Gin — goroutines
- **[[backend/frameworks/rust/index|Rust]]** — Axum, Actix — async/tokio
- **[[backend/frameworks/cpp/index|C++]]** · **[[backend/frameworks/c/index|C]]** — when you'd actually reach for them, and when you wouldn't
...
## [[backend/interview/index|interview/]]
...
- *Does it belong to no domain at all* (clean code, PR structure, design patterns)? → [[concepts/index|concepts/]]
- *Is it how it went in one of my projects?* → [[projects/index|projects/]]
