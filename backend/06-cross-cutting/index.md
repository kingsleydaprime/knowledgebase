...
## Related
- [[backend/index|Backend course]] · [[backend/01-foundations/03-the-request-lifecycle|the request lifecycle]]
- [[backend/frameworks/index|frameworks/]] · [[cybersecurity/04-web-security/index|web security]]
