...
- [[backend/frameworks/java/03-api-design-and-documentation|API Design & Documentation]] — config-resolution and validation patterns that build on this layering
