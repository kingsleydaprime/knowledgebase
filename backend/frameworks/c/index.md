...
**~8,000 words across 4 notes.** `[reference]`. Assumes [[languages/04-c/index|the C course]].
...
If the reason is an existing native codebase, look at [[backend/frameworks/cpp/index|C++]] first — RAII, `std::string` and a real JSON layer remove most of note 02's difficulty.
