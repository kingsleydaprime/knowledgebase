...
**~11,000 words across 6 notes.** `[reference]` — no Go service in this vault yet. Assumes [[languages/02-go/index|the Go course]] and the [[backend/index|backend course]]; these notes cover only what those don't.
