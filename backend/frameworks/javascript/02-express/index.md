...
Minimal and unopinionated: a router, a middleware chain, and nothing else. You supply the [[backend/03-structuring-a-backend/index|structure]] — which is freedom if you know what you're building and a mess if you don't.
