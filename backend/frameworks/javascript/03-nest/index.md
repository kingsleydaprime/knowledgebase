...
- It still runs on Express (or Fastify) underneath, so the [[backend/frameworks/javascript/01-node-runtime/index|runtime]] rules all still apply.

## Related
- [[backend/frameworks/javascript/index|JavaScript backends]] · [[projects/arete/learning/backend/01-fundamentals-and-nestjs|arete: NestJS in a real project]] · [[projects/nextvibe/learning/backend/01-core|nextvibe]]
