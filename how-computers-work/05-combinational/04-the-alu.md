...
**Next:** [[how-computers-work/06-memory/01-latches-and-flip-flops|Module 21 — Latches and Flip-Flops]] begins Part VII and makes the conceptual leap of the whole course: **feedback turns combinational logic into memory.** Every circuit so far forgets everything the instant its inputs change. That is about to stop.
