# Module 19: Adders (Arithmetic from Pure Logic)
...
- You can build any function from gates, and know XOR is the expensive one — [[how-computers-work/04-logic/01-gates-from-transistors|module 14]], [[how-computers-work/04-logic/04-universal-gates|module 17]].
...
> [!NOTE]
> **The cost is area, and it grows fast.** Those expanded expressions need wide AND and OR gates, and the widths grow with the number of bits looked ahead — running straight into the fan-in limits of [[how-computers-work/04-logic/01-gates-from-transistors|module 14]].
>
...
6. **Overlooking XOR's cost.** Each full adder uses two XORs, and XOR is the most expensive common gate (module 14). A 64-bit adder contains 128 of them.
...
**Next:** [[how-computers-work/05-combinational/03-the-alu|Module 20 — The ALU]] wraps the adder together with logic operations and a shifter behind a multiplexer, producing one circuit that performs many operations — the computational core of every processor.
...
- [[how-computers-work/05-combinational/01-multiplexers-and-decoders|Module 18]] — the MUX that selects the ALU's operation
