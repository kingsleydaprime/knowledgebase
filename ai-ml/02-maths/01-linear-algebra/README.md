...
## Related
- [[ai-ml/02-maths/02-calculus/README|calculus]] — the other half of how training actually works
- [[02-what-is-a-model|what-is-a-model]]
- [[03-llms|llms]] — embeddings and attention are built directly on these operations
