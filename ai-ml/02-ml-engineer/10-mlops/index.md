...
The operations half of the ML Engineer role: running models in production reliably. It's "DevOps for ML," so it **cross-links the [[devops/index|DevOps domain]]** for the shared infrastructure (Docker, Kubernetes, CI/CD, Terraform, Prometheus) and focuses here on what's *ML-specific*. Part of the [[ai-ml/02-ml-engineer/index|ML Engineer track]].
...
## Related
- [[devops/index|DevOps]] — the shared infrastructure MLOps runs on
- [[devops/10-observability/index|Observability (DevOps)]] — monitoring, adapted for model drift
- [[devops/06-ci-cd/index|CI/CD (DevOps)]] — pipelines, extended to data + models
