...
- Creating too many engineered features relative to the number of training examples increases overfitting risk (see [[ai-ml/02-ml-engineer/04-model-evaluation/02-overfitting-and-regularization|overfitting-and-regularization]]) — more features isn't automatically better.
