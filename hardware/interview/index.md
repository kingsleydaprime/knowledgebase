...
From the [[hardware/index|Hardware & Embedded course]]. Two files: the electronics/embedded half, and the RF/IoT half.
...
## Related
- [[hardware/index|Hardware course]] · [[INTERVIEW|Interview index]]
