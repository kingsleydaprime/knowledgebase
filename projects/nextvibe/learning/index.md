# nextvibe — Learning Notes

**The largest project in the vault** (142k words). A NestJS + Next.js platform covering auth, realtime, games/AI, payments and payouts — so it's the broadest single body of applied backend and frontend material here.

## System design
- [[projects/nextvibe/learning/00-sys-design|00 — System Design]] → general: [[architecture/index|architecture]]

## Backend
1. [[projects/nextvibe/learning/backend/01-core|01 — Core]] → [[backend/index|backend concepts]]
...
6. [[projects/nextvibe/learning/frontend/06-realtime|06 — Realtime]]
...
- [[projects/nextvibe/learning/10-shell|10 — Shell]] → [[devops/01-linux/index|linux]]

## Archive
The original flat files, kept as reference copies after the split into the domain folders above:
- [[projects/nextvibe/learning/archive/original-flat-backend-learning|original flat backend]]
- [[projects/nextvibe/learning/archive/original-flat-frontend-learning|original flat frontend]]

## Interview
[[projects/nextvibe/interview/index|interview/]]
