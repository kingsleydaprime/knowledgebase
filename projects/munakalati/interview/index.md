...
Questions an interviewer could realistically ask **about this project**, drawn from [[projects/munakalati/learning/index|../learning/]]. Munakalati is the Muna Kalati / MunaWorld site — Next.js 16 + Sanity, with **434 blog posts migrated out of Wix**.

**This is the vault's strongest project for content-modelling and data-migration questions**, and its best source of *silent-bug* stories. It is deliberately weak on auth, databases and testing — [[projects/gees-arise/interview/index|gees-arise]] covers the first two, and nothing here covers the third.
...
## Related
- [[projects/munakalati/learning/index|../learning/]] — the material these come from
- [[projects/index|all projects]] · [[INTERVIEW|the domain interview banks]]
