...
**The most distinctive thing [[projects/munakalati/learning/index|munakalati]] taught.** Moving 434 blog posts from Wix to Sanity — extraction from an API you don't control, rich-text conversion between two incompatible tree formats, idempotent bulk writes, and three repair scripts for what the import got wrong.
...
- [[projects/munakalati/learning/03-sanity/index|03 — Sanity]] — the target system
