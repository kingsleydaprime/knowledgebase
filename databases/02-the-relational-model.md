...
**Literally**, in the sense from [[mathematics/02-discrete-math/04-sets-relations-and-functions|set theory]]:
...
- [[mathematics/02-discrete-math/04-sets-relations-and-functions|Sets, Relations and Functions]] — the maths
