...
- **Stiffness is $EI$**, so — from [[continuum-mechanics/08-linear-elasticity|note 08]] — if a beam is too flexible, changing steel grade won't help. Change $I$
...
The catch is **shear locking** — naive Timoshenko elements go artificially stiff as they get thin, for the same reason volumetric locking happens in nearly-incompressible elasticity. Reduced integration fixes it. → [[continuum-mechanics/13-computational-methods-and-fem|FEM]]
...
**It's the first genuinely nonlinear phenomenon here.** Below $P_{cr}$ the straight configuration is stable; above it, it isn't. That's a **bifurcation**, and it's where linear elasticity stops being sufficient. → [[continuum-mechanics/10-finite-deformation|Finite Deformation]]
...
$D$ is the **flexural rigidity**, and note $h^3$ again — thickness dominates. The $(1-\nu^2)$ is the plane-stress correction from [[continuum-mechanics/08-linear-elasticity|note 08]].
...
- **Holes, notches, sudden section changes** — stress concentration is invisible to beam theory → [[continuum-mechanics/08-linear-elasticity|note 08]]
...
## Related
- [[continuum-mechanics/08-linear-elasticity|Linear Elasticity]] — what these reduce from
- [[continuum-mechanics/13-computational-methods-and-fem|FEM]] — the general method these preceded
- [[continuum-mechanics/12-failure-and-yield|Failure and Yield]] — whether the stress is acceptable
