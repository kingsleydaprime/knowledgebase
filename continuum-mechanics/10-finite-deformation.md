...
**1. Large strains.** Rubber, biological tissue, foams, metal forming. Strains of 100–700%, where the distinction between strain measures is enormous. → [[continuum-mechanics/04-strain-measures|Strain Measures]]
...
**3. Buckling and post-buckling.** Instability is inherently a geometric-nonlinearity problem — the structure's stiffness changes as it deforms. → [[continuum-mechanics/09-beams-and-structures|Beams and Structures]]
...
**Total Lagrangian** — everything referred to the **original** configuration. Uses $\mathbf{S}$ and $\mathbf{E}$ (the second Piola–Kirchhoff / Green–Lagrange pair), which are symmetric, material, and energy-conjugate. → [[continuum-mechanics/05-stress|Stress]]
...
Deriving stress from a potential is what makes the material **path-independent and non-dissipative by construction** — load and unload along any path and you recover exactly the energy you put in. It satisfies the second law automatically. → [[continuum-mechanics/07-constitutive-models|Constitutive Models]]
...
**If a rubber FE model comes out far too stiff, locking is the first thing to check.** → [[continuum-mechanics/13-computational-methods-and-fem|FEM]]
...
- **Watch for negative Jacobians** — an inverted element, meaning the mesh or the increment is too aggressive → [[continuum-mechanics/03-kinematics-of-deformation|Kinematics]]
...
## Related
- [[continuum-mechanics/04-strain-measures|Strain Measures]] — why small strain fails under rotation
- [[continuum-mechanics/05-stress|Stress]] — the three stress tensors this needs
- [[continuum-mechanics/07-constitutive-models|Constitutive Models]] — hyperelasticity in context
- [[continuum-mechanics/13-computational-methods-and-fem|FEM]] — solving these
