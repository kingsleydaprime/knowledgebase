...
That second term is **nonlinear in velocity**, and it is the reason fluid dynamics is hard. Navier–Stokes would be a manageable linear PDE without it; with it you get turbulence, and a Millennium Prize problem. → [[continuum-mechanics/11-viscous-fluids-and-navier-stokes|Navier–Stokes]]
...
Split it, using the symmetric/antisymmetric decomposition from [[continuum-mechanics/02-index-notation-and-tensors|note 02]]:
...
This matters when you solve in terms of stress rather than displacement, and it's the reason **displacement-based finite elements are the default** — assume a continuous displacement field, and compatibility is satisfied automatically. → [[continuum-mechanics/13-computational-methods-and-fem|FEM]]
...
**That last point is why linear elasticity is tractable at all** — you can solve for one load case and add. → [[continuum-mechanics/08-linear-elasticity|Linear Elasticity]]

**When it fails:** rubber, biological tissue, metal forming, buckling, and anything with large rotations. A cantilever tip deflecting 30% of its length has small *strains* and large *rotations*, and the small-strain tensor gets it wrong — a rigid rotation registers as spurious strain. That's the case for finite deformation. → [[continuum-mechanics/10-finite-deformation|Finite Deformation]]

---

## Related
- [[continuum-mechanics/04-strain-measures|Strain Measures]] — quantifying what $\mathbf{F}$ describes
- [[continuum-mechanics/06-conservation-laws|Conservation Laws]] — where the material derivative earns its keep
- [[continuum-mechanics/11-viscous-fluids-and-navier-stokes|Navier–Stokes]] — $\mathbf{D}$ in action
