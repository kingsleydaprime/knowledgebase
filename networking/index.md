...
The foundation layer under [[devops/index|DevOps]], [[cybersecurity/index|cybersecurity]], [[architecture/index|distributed systems]], and every backend service you will ever debug. This folder was empty for a long time while three domains that *depend* on it were built out — this is the floor going in underneath them.
...
**Every note opens with a plain-language "kid version first" intuition before going to full depth, and ends with a Key insight.** Same convention as [[architecture/04-distributed-systems/index|distributed systems]].
...
| [[devops/08-networking-and-web/index\|devops/08-networking-and-web]] | operations | Which DNS record do I set? How do I configure nginx? |
| [[cybersecurity/03-network-security/index\|cybersecurity/03-network-security]] | defence | How is this attacked, and how do I stop it? |
