...
*The one domain where **the reps are their own portfolio.** Games hiring weights a shipped thing more heavily than most software hiring — a jam entry with twenty ratings outperforms a perfect interview answer.*
...
**Ship a game jam entry.** 48 hours, a hard deadline, and a finished thing — which is the exact skill the industry screens for, and the one this vault has least of.
