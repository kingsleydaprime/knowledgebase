...
**Same convention as [[backend/frameworks/index|backend/frameworks/]]:** the concepts live in the numbered course; this is *"how **this** engine does what the course already explained."* Read [[game-development/02-engines-and-the-game-loop|note 02]] first and these become short.
...
**Not features — how much the engine has already decided for you**, exactly as in [[backend/frameworks/python/index|backend frameworks]]:
...
**Learning, or 2D, or you want to read the engine you're using** → **Godot**. MIT, small, GDScript is close enough to [[languages/06-python/index|Python]] to be productive on day one.

**A job, or mobile/VR, or the largest asset ecosystem** → **Unity**. It has the deepest job market by a wide margin, and C# is a genuinely good language → [[languages/07-csharp/index|C#]].
...
## Related
- [[game-development/index|game-development/]] — the course
