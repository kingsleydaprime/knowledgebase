...
Passwords, API keys, TLS private keys, and database credentials must never live in git or a plaintext env file in a repo. This section covers how secrets are stored, injected, and rotated safely. Part of the [[devops/index|DevOps curriculum]].
