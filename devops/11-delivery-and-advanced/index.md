...
The advanced delivery topics that sit on top of everything before: driving deployments declaratively from git, storing build outputs, managing service-to-service traffic at scale, and the architectural patterns for building resilient cloud systems. Part of the [[devops/index|DevOps curriculum]].
...
## Related
- [[devops/05-orchestration/index|Orchestration]] — what GitOps and service meshes operate on
- [[devops/06-ci-cd/index|CI/CD]] — GitOps is the delivery half of the pipeline
