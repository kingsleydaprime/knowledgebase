...
The network layer a DevOps engineer must actually understand: the protocols underneath everything (DNS, HTTP/S, TLS, SSH, the OSI model), and the web-serving infrastructure that sits in front of applications (Nginx, reverse proxies, load balancers, caching). Part of the [[devops/index|DevOps curriculum]].
...
- [[devops/09-secret-management/index|Secret Management]] — TLS certificates are secrets
