...
Managing servers, networks, and cloud resources through version-controlled code instead of clicking around a console. Two related but distinct disciplines: **provisioning** (creating the infrastructure) and **configuration management** (setting up what runs on it). Part of the [[devops/index|DevOps curriculum]].
...
- [[devops/06-ci-cd/index|CI/CD]] — where IaC actually runs in a pipeline
- [[devops/09-secret-management/index|Secret Management]] — IaC must never hardcode secrets
