...
[[devops/01-linux/15-rhcsa/index|15-rhcsa/]] — a structured cert-prep course built on top of everything above, going deeper on RHEL specifics (SELinux contexts, firewalld zones and rich rules, Podman, Stratis, image mode).
