...
Once you have more than a handful of containers ([[devops/02-docker/index|02-docker]]), you need something to schedule them across machines, restart them when they die, scale them, and route traffic to them. That something is an orchestrator — and in practice it means **Kubernetes**. Part of the [[devops/index|DevOps curriculum]].
...
## Related
- [[devops/02-docker/index|Docker]] — the containers this section orchestrates
- [[devops/06-ci-cd/index|CI/CD]] — how images get built and deployed into a cluster
