...
| | |
|---|---|
| [[devops/10-observability/index\|10-observability/]] | **The prerequisite.** SLI/SLO/SLA and error budgets live there; note 02 deliberately doesn't repeat them |
...
**What's missing:** chaos engineering in any depth (it's in [[devops/devops-reference|devops-reference]] and [[architecture/04-distributed-systems/15-testing-distributed-systems|distributed systems testing]]), FinOps and cost as a reliability constraint, progressive delivery specifics, compliance frameworks (SOC 2, ISO 27001 — see [[cybersecurity/08-governance-risk-and-compliance/index|GRC]]), and anything about the politics of actually introducing these to an organisation that hasn't asked for them, which is the hardest part in practice.

→ [[PRIMETECHIE|Reading is not a rank.]]

## Related
- [[devops/index|DevOps]] — the folder this closes
- [[devops/00-the-physical-layer/index|00-the-physical-layer/]] — the other end of the same course
