...
Continuous Integration and Continuous Delivery/Deployment: automatically building, testing, and shipping code on every change, so integration problems surface in minutes instead of at a painful merge weeks later. Part of the [[devops/index|DevOps curriculum]].
...
- **Branching strategies, branch protection, PR practice, semantic versioning** → [[git/index|the git course]]. A pipeline enforces these rules; it doesn't define them. Specifically [[git/13-branching-strategies|13-branching-strategies]] and [[git/14-github-and-ci|14-github-and-ci]]
- **The deploy targets** → [[devops/02-docker/index|Docker]], [[devops/05-orchestration/index|Orchestration]], [[devops/04-vps/vps-deployment-reference|VPS]]
- **What the deploy stage invokes** → [[devops/07-infrastructure-as-code/index|Infrastructure as Code]]
...
- [[devops/index|DevOps curriculum map]]
- [[git/index|Git course]] — version control, the roadmap's VCS pillar
- [[languages/01-java/03-tooling/04-testing|Testing (Java)]] — the test gates a CI pipeline enforces
- [[devops/10-observability/index|Observability]] — how you know a deploy went well
