...
Cloud provider fundamentals: the landscape of providers, the core service categories every one of them offers, the serverless model, and how the whole thing is billed and secured. Part of the [[devops/index|DevOps curriculum]].
...
## Related
- [[devops/05-orchestration/index|Orchestration]] — managed Kubernetes runs on these providers
