...
Securing workloads in the cloud, where **the perimeter dissolves and misconfiguration — not exotic exploits — causes most breaches.** Heavily overlaps the [[devops/index|DevOps domain]], so this **cross-links there** for the infrastructure mechanics and focuses on the *security* lens. Part of the [[cybersecurity/index|Cybersecurity course]].
...
- [[devops/09-secret-management/index|Secret Management (DevOps)]] — keeping keys out of code
- [[devops/05-orchestration/index|Kubernetes (DevOps)]] — what container security secures
- [[cybersecurity/07-security-operations/index|Security Operations]] — cloud detection & response
