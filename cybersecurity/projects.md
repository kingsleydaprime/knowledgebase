...
- 🟢 ⭐ **PortSwigger Web Security Academy** — free, and the best security learning resource that exists. Maps directly onto [[cybersecurity/04-web-security/index|web security]] and [[cybersecurity/02-ethical-hacking/07-exploitation-concepts|exploitation concepts]]. **Done when:** you've cleared the SQLi, XSS, and access-control paths.
...
- [[cybersecurity/index|the cybersecurity course]] · [[cybersecurity/interview/index|interview bank]]
