...
## Related
- [[cybersecurity/14-api-security/index|API security]] — the same principles for machine clients, minus the browser: BOLA, JWT, SSRF, the OWASP API Top 10
- [[cybersecurity/index|cybersecurity curriculum map]]
- [[cybersecurity/03-network-security/index|network-security]] — the network-layer counterpart to this folder's application-layer focus
