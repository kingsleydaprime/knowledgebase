...
## Related
- [[cybersecurity/index|cybersecurity curriculum map]] · [[cybersecurity/04-web-security/index|web security]] — the parent discipline
- [[backend/02-api-design/index|API design]] · [[backend/05-auth/index|backend/auth]] — the building side
- [[cybersecurity/02-ethical-hacking/index|ethical hacking]] — API testing as modern web pentesting
- [[cybersecurity/09-cloud-security/index|cloud security]] — the SSRF-to-metadata path
