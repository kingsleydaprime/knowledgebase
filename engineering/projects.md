...
_26 notes, ~41,000 words, and the vault's bluntest `[reference]` label: **this material validates against an experiment, not a compiler.** These projects are the cheapest available substitute — simulate it, then check the simulation against something physical you can measure._
...
**Balance a physical inverted pendulum.** It's the only project here that validates against reality rather than against another equation — which is exactly the gap [[engineering/index|the folder's own README]] admits to.

## Related

- [[engineering/index|the engineering courses]]
- [[foundations/numerical-methods/index|numerical methods]] — the solvers under all of this
