...
**~22,000 words across 13 notes.** Built August 2026. `[reference]` — see [[engineering/index|the domain note]] on what that means here, because it means something sharper in a physical field than in a software one.
...
- ~~**Numerical methods**~~ — **now written**: [[foundations/numerical-methods/index|foundations/numerical-methods/]] (quadrature, sparse solvers, conditioning, stability)
...
## Related
- [[engineering/index|Engineering]] — the umbrella
- [[engineering/02-control-theory/index|Control Theory]] — the other track: controlling the systems this one describes
