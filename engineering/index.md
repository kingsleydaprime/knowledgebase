...
1. [[engineering/01-continuum-mechanics/index|01-continuum-mechanics/]] — **[Advanced]** — how solids and fluids deform and flow, treated as continuous media. Tensors, strain, stress, the conservation laws, constitutive models, elasticity, Navier–Stokes, failure, and an entry into FEM
2. [[engineering/02-control-theory/index|02-control-theory/]] — **[Intermediate → Advanced]** — making a system behave despite a wrong model and real disturbances. Transfer functions, PID and how to actually tune one, stability, root locus, Bode and Nyquist, state space, observers and Kalman, LQR and MPC, digital implementation, and an entry into nonlinear control
...
| | |
|---|---|
| [[hardware/index\|hardware/]] | the electronics layer — this is the mechanical one |
| [[robotics/index\|robotics/]] | draws on `02-control-theory` for the whole control half; its notes 07–08 carry the Jacobians and manipulator dynamics |
| [[ai-ml/00-foundations/03-mathematics/index\|the maths notes]] | linear algebra and calculus, at the level ML needs. This domain needs more — tensor calculus and PDEs |
| [[foundations/numerical-methods/index\|numerical methods]] | **now written** — quadrature, sparse solvers, ODE/PDE discretisation, stability. FEM and CFD both sit on it |
...
- [[hardware/index|Hardware & Embedded]] — the layer this sits beside
- [[robotics/index|Robotics]] — where mechanics and control meet
- [[research/index|Research]] — how to read the papers this field is written in
