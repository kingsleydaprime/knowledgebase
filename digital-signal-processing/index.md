...
**Turning real-world signals into numbers, and doing useful things to them.** A 9-note course built Aug 2026, filling the gap between [[hardware/06-radio-frequency|hardware/RF]] (the analog/antenna side) and [[foundations/information-theory/index|information theory]] (the limits) — and, unexpectedly, the maths under a [[ai-ml/02-ml-engineer/06-computer-vision/index|CNN's convolution layer]].
