...
The combine step (the "butterfly") reuses shared computations that the naive DFT redundantly repeats — **that reuse is where the saving comes from** → [[01-growth-and-asymptotic-notation|divide and conquer]].
...
- [[01-growth-and-asymptotic-notation|algorithms]] — divide and conquer, and O(N log N)
