...
| **Detect a cycle, undirected** | [[10-union-find|Union-find]], or DFS |
| **Detect a cycle, directed** | DFS with three colours — lesson 02 |
| **Connect everything at minimum total cost** | [[12-minimum-spanning-tree|Minimum spanning tree]] |
| **Which groups are mutually reachable?** | SCCs — lesson 02 |
