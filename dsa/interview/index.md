...
From [[dsa/index|the DSA course]] and [[dsa/04-patterns/index|the 15 patterns]]. This folder is about **how to run a coding interview**, not about grinding more problems — the problems live in [[dsa/neetcode-150/interview-playbook|the NeetCode playbook]].
...
The single highest-value thing from [[dsa/04-patterns/index|the patterns folder]] — what the problem's phrasing tells you to reach for:

| The problem says… | Reach for | Pattern |
|---|---|---|
| sorted array, find a pair/triplet | two pointers | [[dsa/04-patterns/02-two-pointers\|02]] |
| contiguous subarray, "longest/shortest with…" | sliding window | [[dsa/04-patterns/03-sliding-window\|03]] |
| range sums, queried repeatedly | prefix sum | [[dsa/04-patterns/01-prefix-sum\|01]] |
| cycle in a linked list, find the middle | fast/slow pointers | [[dsa/04-patterns/04-fast-slow-pointers\|04]] |
| "next greater/smaller element" | monotonic stack | [[dsa/04-patterns/06-monotonic-stack\|06]] |
| top/smallest K, or a running median | heap | [[dsa/04-patterns/07-top-k-elements\|07]] |
| merge/insert intervals | sort by start, then sweep | [[dsa/04-patterns/08-overlapping-intervals\|08]] |
| sorted, or a monotonic predicate | binary search — **including on the answer** | [[dsa/04-patterns/09-modified-binary-search\|09]] |
| shortest path, unweighted | BFS | [[dsa/04-patterns/12-bfs-pattern\|12]] |
