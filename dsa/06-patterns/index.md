# LeetCode Patterns — University-Style Teaching Notes

15 recurring problem-solving patterns, revised to university / high-school course quality per [[COURSE-STANDARD|the course standard]]. Each pattern has prerequisites, observable outcomes, motivation, definitions, a step-by-step mechanism, a complete runnable example, independent practice with checks, and a demonstrable finish line. The teaching moves borrow from [[foundations/dsa/04-data-structures/index|DSA 04-data-structures]] — motivation before machinery, definitions before terminology, concrete examples with predictions, and independent implementation tasks.

15 recurring problem-solving patterns, based on ["LeetCode was HARD until I Learned these 15 Patterns" (Ashish Pratap Singh, blog.algomaster.io)](https://blog.algomaster.io/p/15-leetcode-patterns), reworked and expanded with the mechanics already written up in the parent [[foundations/dsa/index|DSA notes]]. The pitch of the source article, worth keeping in mind: LeetCode is less about the number of problems solved and more about how many patterns you recognize — most "new" problems are a known pattern wearing a different costume.

Several of these link back to a foundations note for the underlying mechanics (traversal orders, DFS, BFS) rather than re-explaining them — this folder is about _recognizing which pattern applies and why_, not re-deriving the algorithm from scratch.
...
- [[foundations/dsa/index|DSA fundamentals index]]
