...
15 recurring problem-solving patterns, revised to university / high-school course quality per [[COURSE-STANDARD|the course standard]]. Each pattern has prerequisites, observable outcomes, motivation, definitions, a step-by-step mechanism, a complete runnable example, independent practice with checks, and a demonstrable finish line. The teaching moves borrow from [[foundations/dsa/04-data-structures/|DSA 04-data-structures]] — motivation before machinery, definitions before terminology, concrete examples with predictions, and independent implementation tasks.
