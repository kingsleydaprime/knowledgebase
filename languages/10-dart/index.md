...
**Google's client-application language, and in practice: the language you learn to use [[mobile/frameworks/flutter/index|Flutter]].**

**6 notes, built Aug 2026** alongside [[mobile/index|the mobile track]]. `[reference]`.
...
Written for the [[mobile/index|mobile track]], because Flutter is one of the four stacks in [[mobile/frameworks/index|frameworks/]] and the vault had nothing on Dart.
...
## Related
- [[mobile/frameworks/flutter/index|Flutter]] — the reason this language exists for you
- [[mobile/index|mobile]] — the course this was written alongside
- [[languages/index|languages]] · [[languages/projects|projects]]
- [[languages/09-kotlin/index|Kotlin]] — the closest comparison, and the one Dart is usually weighed against
