...
From [[languages/06-python/index|the Python course]]. **Python interviews test the data model and the gotchas, not syntax** — and the questions cluster tightly, because the same handful of behaviours account for most real Python bugs.
