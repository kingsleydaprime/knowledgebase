...
**~12 notes, built Aug 2026** alongside [[mobile/index|the mobile track]]. `[reference]`.
...
The vault had [[game-development/engines/unity|C# for Unity]] and no Swift — so it covered Apple's ecosystem nowhere, despite iOS being half of [[mobile/index|mobile]]. This closes that.
...
## Related
- [[mobile/frameworks/ios/index|iOS]] — the platform this language exists for
- [[mobile/index|mobile]] — the course this was written alongside
- [[languages/index|languages]] · [[languages/projects|projects]]
- [[languages/03-rust/index|Rust]] — the nearest comparison: same safety instincts, stricter enforcement
