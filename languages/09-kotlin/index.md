...
**8 notes, built Aug 2026** alongside [[mobile/index|the mobile track]]. `[reference]`.
...
[[languages/index|languages/index]] listed Kotlin as a track that "would slot in if notes got written." They hadn't been — despite Kotlin being **the** Android language, and Android being half of [[mobile/index|mobile]].

**Note this is deliberately shorter than the other language courses**, because [[languages/01-java/index|the Java course]] already covers the JVM, GC, the memory model and the collections framework — all of which apply unchanged. **This covers what Kotlin adds.**
