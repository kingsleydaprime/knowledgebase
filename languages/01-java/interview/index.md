...
Question bank from the [[languages/01-java/index|Java course]], weighted toward what a **low-latency / systems** role screens for — that's the stated target in [[PRIMETECHIE|the Primetechie path]], and file 02 is where those interviews are actually won or lost.
