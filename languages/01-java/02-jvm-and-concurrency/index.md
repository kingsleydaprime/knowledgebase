...
## Practice
- [[languages/01-java/02-jvm-and-concurrency/exercises/index|Exercises]] — two unsolved, runnable exercises (a bounded blocking queue and a token-bucket rate limiter) with a red-to-green test harness. The notes give the vocabulary; these build the reps.
