...
Everything around the code: building it, wiring it together, testing it, and seeing what it's doing in production. Part of the [[languages/01-java/index|Java course]].
...
## Related
- [[languages/01-java/05-web-and-api/index|Web & API]] — where DI and these tools get applied
