...
The Java language itself, beginner to fluent — before any framework or the JVM internals underneath. Part of the [[languages/01-java/index|Java course]].
...
## Related
- [[languages/01-java/02-jvm-and-concurrency/index|JVM & Concurrency]] — what runs the code above
