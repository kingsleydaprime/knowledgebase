...
**[Beginner → Advanced]** — the language, the JVM, and the backend ecosystem built on top of it. Part of the [[languages/index|languages]] course.
...
### [[languages/01-java/02-jvm-and-concurrency/index|02 — JVM & Concurrency]]
...
- [[languages/01-java/02-jvm-and-concurrency/exercises/index|Exercises]] — unsolved, runnable reps (bounded blocking queue, token-bucket rate limiter)

### [[languages/01-java/03-tooling/index|03 — Tooling]]
...
### [[languages/01-java/04-persistence/index|04 — Persistence]]
...
### 05 — Web & API → [[backend/frameworks/java/index|moved to backend/frameworks/java/]]
These three notes were **moved, not duplicated** — `languages/` teaches the language, `backend/frameworks/` teaches the frameworks built on it. [[languages/01-java/05-web-and-api/index|Signpost page]].
...
### [[languages/01-java/06-applied-systems/index|06 — Applied Systems]]
