...
The project-grounded section: building an actual high-throughput data system, not just learning language features. This is where the domain earns its "real engineering" signal — every note here is distilled from a pipeline that moved millions of rows. Part of the [[languages/01-java/index|Java course]].
...
## Related
- [[languages/01-java/02-jvm-and-concurrency/index|JVM & Concurrency]] — the concurrency primitives these systems are built from
