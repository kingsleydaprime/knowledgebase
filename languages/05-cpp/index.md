...
The ~70% memory-safety-bug figure from Microsoft and Google covers C **and** C++. Smart pointers and containers remove most of the easy mistakes; they don't remove the category. That's the entire argument for [[languages/03-rust/index|Rust]] in new systems work, and it's why the four-language comparison is worth keeping in view:
...
Per [[languages/index|the vault rule]]:

### → **[[backend/frameworks/cpp/index|backend/frameworks/cpp/]]** — Drogon, Crow, Pistache, oat++, Boost.Beast
...
- **Embedded C++** — `-fno-exceptions`, `-fno-rtti`, freestanding. Adjacent to [[hardware/index|hardware/]]
...
## Related
- [[languages/04-c/index|C]] — read this first
- [[languages/03-rust/index|Rust]] — the same niche, with the guarantees checked
