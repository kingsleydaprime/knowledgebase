...
The `std::greater` incantation for a min-heap is worth memorising — it's needed constantly in [[dsa/02-data-structures/08-heaps|heap]] problems.
...
- [[dsa/02-data-structures/03-hash-maps|Hash Maps]] and [[dsa/02-data-structures/08-heaps|Heaps]] — what these are underneath
