...
For low-dimensional problems (mobile robots in 2D/3D), discretise and search. → [[dsa/03-algorithms/06-dijkstra|Dijkstra and graph search]]
...
- [[dsa/03-algorithms/06-dijkstra|Dijkstra and graph search]] — A*, Dijkstra, graph search
