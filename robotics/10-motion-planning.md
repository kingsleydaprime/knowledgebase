...
For low-dimensional problems (mobile robots in 2D/3D), discretise and search. → [[02-dijkstra|Dijkstra and graph search]]
...
- [[02-dijkstra|Dijkstra and graph search]] — A*, Dijkstra, graph search
