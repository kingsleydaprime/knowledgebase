...
- 🔴 **Teleoperation with a latency budget** — drive something remotely and measure the end-to-end delay, then make it degrade safely when the link drops rather than continuing at the last command. Joins [[networking/15-network-performance|latency]] to a machine that can hurt someone.
...
**If you do one:** the PID tuning project. It's cheap, it fits on a desk, and it's the difference between having read [[control-theory/04-pid-control|the PID note]] and having earned it.
...
- [[control-theory/projects|control theory projects]] — the control theory under this
