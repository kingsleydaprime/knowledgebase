...
**Avalonia is the one to know about.** It's community-driven, WPF-like, genuinely cross-platform including Linux (which MAUI does not target), and it draws its own controls so rendering is identical everywhere — with the accessibility caveat that implies → [[desktop/frameworks/index|frameworks/]].
...
**C# is a genuinely good language** — mature generics, LINQ, async/await (which it popularised before JavaScript), strong tooling. Closest neighbour in this vault is [[languages/01-java/index|Java]].
...
## Related
- [[desktop/frameworks/index|frameworks/]] · [[languages/01-java/index|Java]] (nearest neighbour here)
