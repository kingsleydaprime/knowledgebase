...
**Distinct from [[ai-ml/index|ai-ml/]]**, which is about how models work. This is about *orchestrating* them — and everything else — into workflows.
...
| | |
|---|---|
| [[ai-ml/03-ai-engineer/index\|AI engineer]] | **The depth behind note 04** — agents, structured output, evals, prompt injection |
| [[backend/02-api-design/index\|API design]] | The other side of every integration |
| [[devops/02-docker/index\|Docker]] · [[devops/04-vps/vps-setup\|VPS]] | What self-hosting runs on |
| [[devops/09-secret-management/index\|secret management]] | The credential-store argument |
| [[architecture/04-distributed-systems/index\|distributed systems]] | Retries, ordering, at-least-once |
