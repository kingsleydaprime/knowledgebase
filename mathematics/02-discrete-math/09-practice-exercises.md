...
- Solutions in [[foundations/mathematics/02-discrete-math/10-practice-exercises-solutions|note 10]]
...
**Done when:** (c) is **not** an if-then statement, and you can say why → [[foundations/mathematics/02-discrete-math/02-logic|note 02]].
...
**Done when:** you can point at the exact step that fails for a perfect square — **that's the step doing the real work** → [[foundations/mathematics/02-discrete-math/03-proof-techniques|note 03]].
...
**Done when:** you can name the exact value of $n$ at which the step fails, and why. **Most people find the flaw in the wrong place** → [[foundations/mathematics/02-discrete-math/05-induction-and-recursion|note 05]].
...
**Done when:** you can say for each whether order matters and whether repetition is allowed, **before computing** → [[foundations/mathematics/02-discrete-math/06-combinatorics-and-counting|note 06]].

**14. Prove the handshake lemma.** $\sum_{v} \deg(v) = 2|E|$. Then use it to prove the number of odd-degree vertices is always even → [[foundations/mathematics/02-discrete-math/07-graph-theory|note 07]].
...
**Done when:** you recover 9, and can say which step would be infeasible if $p$ and $q$ were 300 digits → [[foundations/mathematics/02-discrete-math/08-number-theory-and-modular-arithmetic|note 08]].
...
## Related
- [[foundations/mathematics/02-discrete-math/10-practice-exercises-solutions|Solutions]]
