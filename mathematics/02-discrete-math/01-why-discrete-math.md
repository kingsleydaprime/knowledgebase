...
A build system has tasks with dependencies. **That's a directed graph**, and "can it succeed" means "is it acyclic". The build order is a topological sort. → [[01-topological-sort|Topological Sort]]
