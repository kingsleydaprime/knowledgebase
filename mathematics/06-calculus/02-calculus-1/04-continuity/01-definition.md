...
> [!NOTE]
> **This is bisection, and you have used it.** Halve the interval, check which side changes sign, repeat. It is exactly [[dsa/04-patterns/09-modified-binary-search|binary search]] over a continuous domain, and it is how numerical root-finders work — see [[mathematics/07-applied-and-computational/01-numerical-methods/index|numerical methods]].
>
