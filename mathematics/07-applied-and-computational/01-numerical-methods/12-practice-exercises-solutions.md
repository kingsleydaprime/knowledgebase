...
> **[Intermediate]** · Worked answers to [[mathematics/07-applied-and-computational/01-numerical-methods/11-practice-exercises|note 11]]. **Measured, not estimated**, Python 3.14, August 2026.
...
**The unifying point: Newton is fast and unsafe.** Production root-finders (Brent's method) hybridise — take the fast step when it stays in the bracket, fall back to bisection when it doesn't. **Guaranteed convergence with fast convergence in the common case** → [[mathematics/07-applied-and-computational/01-numerical-methods/03-root-finding|note 03]].
...
**Recognising it matters practically:** chemical kinetics, circuits, control systems and stiff PDE discretisations all show it, and "my ODE solver is mysteriously slow" is almost always this → [[mathematics/07-applied-and-computational/01-numerical-methods/08-ordinary-differential-equations|note 08]].
...
**This is the same $\kappa$ from exercise 3, in a different costume**, and it's why preconditioning matters, why input normalisation helps neural network training, and why Adam's per-parameter scaling works → [[mathematics/07-applied-and-computational/01-numerical-methods/10-numerical-optimisation|note 10]] · [[ai-ml/index|AI & ML]].

## Related
- [[mathematics/07-applied-and-computational/01-numerical-methods/11-practice-exercises|the exercises]]
