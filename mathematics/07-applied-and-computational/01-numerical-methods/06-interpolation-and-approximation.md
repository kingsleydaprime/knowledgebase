...
**Solving for a cubic spline is a tridiagonal system** — $O(n)$, trivially fast. → [[mathematics/07-applied-and-computational/01-numerical-methods/04-linear-systems|Linear Systems]]
...
**NURBS** — rational B-splines, which can represent conic sections exactly. **The standard in CAD and 3D modelling.** → [[computer-graphics/index|Computer Graphics]]
...
**Solve with QR or SVD.** → [[mathematics/07-applied-and-computational/01-numerical-methods/04-linear-systems|Linear Systems]]
