...
| | |
|---|---|
| [[engineering/index\|engineering/]] | **The domain that asked.** FEM, CFD, control discretisation |
...
| [[foundations/gpu-and-parallel-computing/index\|GPU and parallel]] | Where the big linear algebra actually runs |
...
## Related
- [[engineering/index|Engineering]] — the domain that needed this
