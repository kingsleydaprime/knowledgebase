...
**The vault had no way in.** 900+ notes assuming you can already read code: [[foundations/dsa/index|DSA]] assumes arrays and loops, [[languages/index|languages/]] assumes you know what a variable is, [[foundations/software-engineering/index|software engineering]] explains the *profession* to someone who already programs, and [[backend/index|backend]] starts several floors up.
...
| | |
|---|---|
| [[foundations/dsa/index\|DSA]] | **The natural next course.** Note 07 ends exactly where it begins |
| [[languages/index\|languages/]] | Where the syntax gets learned properly — Java, Go, Rust, C, C++ |
| [[foundations/software-engineering/index\|software engineering]] | What this becomes when other people, deadlines and next year are involved |
...
| [[foundations/compilers/index\|compilers]] · [[foundations/computer-architecture/index\|architecture]] | What's underneath — **much later** |
