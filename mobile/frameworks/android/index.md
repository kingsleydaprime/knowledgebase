...
**Kotlin + Jetpack Compose.** The language is [[languages/09-kotlin/index|its own course]]; this is the platform.
...
## Related
- [[languages/09-kotlin/index|Kotlin]] — the language
- [[mobile/index|the mobile course]] · [[mobile/frameworks/index|frameworks]]
- [[languages/01-java/index|Java]] — the JVM foundations still apply
