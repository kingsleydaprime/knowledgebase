...
**TypeScript driving real native components.** If you know [[frontend/frameworks/react/index|React]], you know most of this already.
...
| **TanStack Query** | Server state — **the biggest win you can adopt** → [[frontend/04-state-and-data/index\|server state]] |
...
## Related
- [[frontend/frameworks/react/index|React]] — the model
- [[web3/frameworks/javascript/index|TypeScript patterns]] — the same discipline elsewhere
- [[mobile/14-native-vs-cross-platform|native vs cross-platform]] — when to choose this
- [[mobile/index|the mobile course]]
