...
**The delay row is the one to stare at.** A pure delay costs you *nothing* in magnitude and *unbounded* phase. It gives you no benefit and takes away the thing keeping you stable. → [[control-theory/03-time-response|Time delay]]
...
Recall from [[control-theory/02-modelling-and-transfer-functions|note 02]]:
...
**Uncertainty is naturally expressed here.** "My model is good to 100 rad/s and I don't trust it above that" is a frequency-domain statement, and robust control is built on it. → [[control-theory/07-nyquist-and-robustness|Nyquist and Robustness]]
...
## Related
- [[control-theory/05-stability-and-root-locus|Stability and Root Locus]] — the time-domain view
- [[control-theory/07-nyquist-and-robustness|Nyquist and Robustness]] — margins done properly
- [[control-theory/04-pid-control|PID Control]] — what P, I and D do to these plots
