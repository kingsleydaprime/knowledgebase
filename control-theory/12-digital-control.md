...
**This eats phase margin**, and it's the single most common reason a controller that simulated beautifully oscillates on hardware. → [[control-theory/06-frequency-response|Frequency Response]]
...
**Integral windup.** Same as ever, and no less common in digital form. → [[control-theory/04-pid-control|PID Control]]

**Derivative on quantised measurements.** The derivative of a staircase is a series of spikes. **Filter it, always** — and consider estimating velocity with an observer instead of differencing. → [[control-theory/10-observers-and-kalman|Observers]]
...
## Related
- [[control-theory/04-pid-control|PID Control]] — the controller you're discretising
- [[control-theory/08-state-space|State Space]] — the discrete state-space form
- [[control-theory/06-frequency-response|Frequency Response]] — where the hold delay costs you
