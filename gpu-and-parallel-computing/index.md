...
| [[foundations/computer-architecture/index\|computer architecture]] | The CPU this is contrasted against |
...
| [[foundations/computer-graphics/index\|computer graphics]] | What GPUs were originally built for |
...
**What's missing:** ~~exercises~~ — **closed by notes 8–9 (Aug 2026)**; ray tracing hardware, graphics pipeline specifics (that's [[foundations/computer-graphics/index|computer graphics]]), FPGA and ASIC design, sparse and irregular workloads in depth, and power/thermal management.
...
- [[foundations/computer-architecture/index|Computer Architecture]] — the CPU side
- [[foundations/numerical-methods/index|Numerical Methods]] — what runs on this hardware
