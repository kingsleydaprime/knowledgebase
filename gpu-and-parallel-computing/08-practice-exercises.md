...
Solutions in [[gpu-and-parallel-computing/09-practice-exercises-solutions|note 09]].
...
**Done when:** your speedup curve flattens, and you can estimate the serial fraction $s$ from the plateau via $1/s$ → [[gpu-and-parallel-computing/01-why-parallelism|note 01]].
...
**Done when:** block size 1 is catastrophically slow, you know why 32 matters specifically, and you can state your GPU's warp size → [[gpu-and-parallel-computing/02-gpu-architecture|note 02]].
...
**Done when:** you can state what fraction of total time was *compute*. **It will be small, and that is the single most important number in this course** → [[gpu-and-parallel-computing/05-memory-and-data-movement|note 05]].
...
**Done when:** you can state the arithmetic intensity of each (FLOPs per byte loaded) and why tiling improves it → [[gpu-and-parallel-computing/06-performance-and-the-roofline|note 06]].
...
**Done when:** you can say which are memory-bound and which compute-bound **before running them**, and your measurements agree → [[gpu-and-parallel-computing/06-performance-and-the-roofline|note 06]].
...
## Related
- [[gpu-and-parallel-computing/09-practice-exercises-solutions|Solutions]]
- [[gpu-and-parallel-computing/index|the course]]
- [[computer-architecture/13-practice-exercises|architecture exercises]] — the same method on the CPU
