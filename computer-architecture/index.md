...
How you get from logic gates to something that runs a program, and why that machine has the performance characteristics it does. **The layer between [[foundations/os/index|operating systems]] and [[hardware/02-digital-and-analog|digital logic]]** — and the source of every constant the rest of this vault quotes.
...
| | |
|---|---|
| [[foundations/os/index\|operating systems]] | Sits directly on this — virtual memory, scheduling, syscalls |
...
**That makes the gap less excusable than in [[engineering/index|engineering/]] or [[robotics/index|robotics/]].** No hardware to buy, no lab. Just `perf` and an afternoon.
...
## Related
- [[foundations/os/index|Operating Systems]] — the layer above
