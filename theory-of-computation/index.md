...
| [[01-growth-and-asymptotic-notation\|algorithms]] | Complexity analysis, and why some problems have no good algorithm |
...
- **Build a regex engine** — Thompson's construction, then subset construction. **A few hundred lines, and it makes the equivalences concrete.** It's the natural companion to [[build-your-own-shit/index|build-your-own-shit]], and arguably belongs there
