...
**Read this alongside [[web3/03-smart-contracts-with-solidity/index|section 03]], not after it.** In this domain security isn't an advanced topic bolted onto the language — it's the reason the language is used the way it is.
...
- [[cybersecurity/index|cybersecurity]] — the parent discipline, and what doesn't transfer
- [[web3/03-smart-contracts-with-solidity/10-testing-and-tooling|testing and tooling]] — fuzzing and invariants
- [[cybersecurity/06-attacks-and-threats/index|attacks and threats]] — the web equivalents
