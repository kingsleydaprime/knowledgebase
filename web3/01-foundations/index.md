...
3. [[web3/01-foundations/03-cryptographic-primitives|cryptographic-primitives]] — **[Intermediate]** — hashes as *identity*, Merkle proofs, recoverable signatures, and BIP-32/39/44. Assumes [[cybersecurity/05-cryptography/index|the cryptography course]] and covers only what's blockchain-specific
...
- [[web3/02-ethereum-and-the-evm/index|02-ethereum-and-the-evm]] — the next layer up
- [[architecture/04-distributed-systems/index|distributed systems]] — the parent field
