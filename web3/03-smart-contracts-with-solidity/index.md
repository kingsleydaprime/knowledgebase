...
**Writing programs for the machine in [[web3/02-ethereum-and-the-evm/index|section 02]].** Solidity is a small language pointed at a very strange computer — most of what surprises you is the EVM showing through.

**Read [[web3/04-smart-contract-security/index|section 04]] alongside this one, not after it.** The security material isn't an advanced topic here; it's part of learning the language.
...
- [[web3/04-smart-contract-security/index|04-smart-contract-security]] — read in parallel
- [[web3/frameworks/solidity/index|the Solidity toolchain]] — Foundry, Hardhat, OpenZeppelin
- [[web3/frameworks/rust/index|Rust for web3]] — the other major contract language
