...
**The language is covered in [[web3/03-smart-contracts-with-solidity/index|section 03]].** This is the tooling around it.
...
## Related
- [[web3/03-smart-contracts-with-solidity/index|smart contracts with Solidity]] — the language
