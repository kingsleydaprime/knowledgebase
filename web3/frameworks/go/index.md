...
**Go's fit is the same as everywhere else:** concurrency, deployment simplicity, and long-lived network services. Nothing web3-specific about why it's used → [[languages/02-go/index|Go]].
...
## Related
- [[languages/02-go/index|Go]] — the language
