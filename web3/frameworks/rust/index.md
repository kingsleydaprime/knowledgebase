...
**Assumes [[languages/03-rust/index|the Rust course]].** Ownership, traits and `Result` are prerequisites here, not topics.
...
**For infrastructure:** read Reth. It's well-structured, actively developed, and reading a real client teaches more about [[web3/02-ethereum-and-the-evm/index|Ethereum]] than any amount of documentation.
