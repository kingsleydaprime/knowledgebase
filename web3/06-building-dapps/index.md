...
**The note that saves the most rework is [[web3/06-building-dapps/04-indexing-and-events|04-indexing-and-events]].** Discovering that you cannot query a blockchain _after_ designing your product is a common and expensive surprise.
...
- [[web3/frameworks/javascript/index|JS/TS for web3]] — viem, wagmi, the code
- [[frontend/index|frontend]] — the 90% of a dapp that's ordinary web development
- [[web3/03-smart-contracts-with-solidity/index|smart contracts]] — the other side of the wire
