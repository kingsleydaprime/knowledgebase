...
- [[git/15-the-github-cli|The GitHub CLI]] — every rule on this page, driven from the terminal
- [[devops/06-ci-cd/index|DevOps → CI/CD]] — GitHub Actions itself, in depth, across 10 notes
