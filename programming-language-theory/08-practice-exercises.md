...
Solutions in [[programming-language-theory/09-practice-exercises-solutions|note 09]].
...
**Done when:** each is fully reduced with **every substitution written out** → [[programming-language-theory/02-lambda-calculus|note 02]].
...
**Done when:** you can state why a language with strict evaluation needs a different fixpoint combinator → [[programming-language-theory/03-semantics|note 03]].
...
**Done when:** you have two different outputs from one program, and can say which strategy Haskell, Python and Rust use → [[programming-language-theory/03-semantics|note 03]].
...
**Done when:** it accepts well-typed terms and rejects ill-typed ones **with a useful message** → [[programming-language-theory/04-type-systems-formally|note 04]].
...
**Done when:** you get $(\alpha \to \alpha) \to \alpha \to \alpha$ **without being told**, and your unifier performs the **occurs check** → [[programming-language-theory/05-type-inference|note 05]].
...
**Done when:** you can explain **why excluded middle has no inhabitant** in a constructive setting → [[programming-language-theory/06-curry-howard-and-proofs|note 06]].
...
**Done when:** you can connect the rules to Rust's move semantics and say which Rust feature corresponds to weakening → [[programming-language-theory/07-effects-and-substructural-types|note 07]] · [[languages/03-rust/index|Rust]].

## Related
- [[programming-language-theory/09-practice-exercises-solutions|Solutions]]
- [[programming-language-theory/index|the course]]
- [[compilers/index|compilers]] · [[build-your-own-shit/04-your-own-language|build your own language]]
