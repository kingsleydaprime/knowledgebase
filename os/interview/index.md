...
From [[os/fundamentals|foundations/os]]. The layer directly beneath [[networking/index|networking]], [[languages/01-java/02-jvm-and-concurrency/index|the JVM]], and [[devops/01-linux/index|Linux]] — thin as a folder, but the questions here underpin all three.

## Files
1. [[os/interview/01-processes-memory-and-io|Processes, Memory & I/O]] — processes vs threads, context switching, virtual memory, page cache, syscalls, scheduling, deadlock
...
- [[networking/09-sockets-and-the-network-api|Sockets]] — file descriptors, epoll, io_uring
