...
**[Beginner → Advanced]** — a JavaScript 3D graphics library wrapping WebGL: scenes, cameras, lights, geometry, and materials rendered onto a canvas. A different domain from [[frontend/03-gsap/README|GSAP]]/[[frontend/04-framer-motion/README|Framer Motion]] (2D DOM/SVG animation) — this is real-time 3D rendering. Part of the [[frontend/README|frontend]] course.
...
- [[frontend/03-gsap/README|GSAP]] / [[frontend/04-framer-motion/README|Framer Motion]] — 2D animation libraries, different rendering model entirely
