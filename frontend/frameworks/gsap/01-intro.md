...
- [[frontend/frameworks/next/README|Next.js]] — GSAP typically runs inside `useEffect`/`useGSAP` in a React/Next context, see [[06-react-integration|react integration]]
